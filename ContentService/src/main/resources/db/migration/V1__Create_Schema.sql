...
CREATE TABLE content_schema.game_mode (
    ...
    max_points_per_question INT NOT NULL DEFAULT 1000, -- Default max points per question
    milliseconds_per_question INT DEFAULT 0, -- Default value in milliseconds; 0 = no time limit
